...
class Acao
{
	...
	private:
		...
		void			_mostrarCabecalho(string texto) const;
		void			_mostrarSeparador(void) const;
		void			_mostrarRodape(void) const;
	...
	public:
		...
		void	mostarSobreEmpresa(void) const;
		void	mostarInfoAcao(void) const;
		void	mostrarHistoricoDividendos(void) const;
		void	mostrarHistoricoComercial(void) const;
};
